...
public class CalculatorTask {
    public static void main(String[] args) {
        String expressionText = "21+(-1+5*2)";
        ArrayList<String> array = elementAnalyze(expressionText);
        ArrayList<Element> elements = elementAnalyze(array);
    ...
    public static ArrayList<String> elementAnalyze(String inputString) {
        ...
        if (!expText.matches("[\\d()*/+-]*")) {
            throw new RuntimeException("Выражение состоит из некорректных символов");
        }
        ...
        while (true) {
            ...
            switch (element.type) {
                ...
                case MINUS:
                    ...
                    return value;
                default:
                    throw new RuntimeException("Между элементами отсутствует математическое действие " + element.value
                            + " at position: " + elements.getCounter());
            }
        }
    }
